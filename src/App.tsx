...
import { Gauge, Gamepad2, Keyboard, Mouse, Palette, Play, Plus, RefreshCw, Settings, SlidersHorizontal, BookOpen, Trash2, Upload, Zap } from "lucide-react";
...
type Tab = "overview" | "buttons" | "performance" | "profiles" | "help" | "settings";
...
const tabs: { id: Tab; label: string; icon: typeof Mouse }[] = [
  ...
  { id: "performance", label: "Performance", icon: Gauge }, { id: "profiles", label: "Profiles", icon: Gamepad2 }, { id: "help", label: "Help", icon: BookOpen }, { id: "settings", label: "Settings", icon: Settings },
];
